(function () {
  ...
  var revealTargets = document.querySelectorAll(
    ".hero-inner, .about-inner, .offer-inner, " +
    ".testimonials-inner, .pricing-inner, .format-inner, .trial-inner"
  );
  ...
  var state = {
    ...
    need: null,      // english: ОГЭ / ЕГЭ / Разговорный английский / Другое
    base: null,      // arabic: level
  ...
  function buildTelegramUrl(s) {
    var direction = s.subject === "english" ? "английский" : "арабский";
    var goal = s.subject === "english" ? (s.need || "не указано") : (s.base || "не указано");
